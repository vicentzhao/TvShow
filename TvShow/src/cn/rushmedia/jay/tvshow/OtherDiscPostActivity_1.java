...
public class OtherDiscPostActivity_1 extends BaseActivity {
	int upid;
		...
		new AsyncTask<Void, Void, JSONArray>(){
			...
			protected JSONArray doInBackground(Void... params) {
				try {
					...
					userInfo= (User) userIntent.getSerializableExtra("userinfo");
							
							userid=userInfo.getId();
						
					//	String path ="http://tvsrv.webhop.net:8080/api/users/"+userid+"/homeline";
					String path ="http://tvsrv.webhop.net:8080/api/users/"+userid+"/repostmys?"+"page="+page+"&count="+count+"";
						//String path ="http://tvsrv.webhop.net:8080/api/users/"+userid+"/commentmys";
						JsonUtil jsut = new JsonUtil();
						String  jsstring =jsut.getStringSource(path);
