...
public class NewFile_topic_Activity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
	   ...
	   // actor.setText(movie.getActor());
	    ...
	    btn_movie_new_about.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				  Intent sameTopicIntent = new Intent(NewFile_topic_Activity.this,SameTopicListActivity.class);
	    ...
	    btn_movie_exit.setOnClickListener(new OnClickListener() {
	    	@Override
	    	public void onClick(View v) {
	    		Intent i = new Intent(NewFile_topic_Activity.this,TableActivity.class);
	    		startActivity(i);
	    		finish();
	    	}
	    });
	    ...
	    back_button.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent  i = new Intent(NewFile_topic_Activity.this,TopicDetialActivity.class);
