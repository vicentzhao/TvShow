...
public class SameTopicList_postActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ProgressDialog pd = new ProgressDialog(SameTopicList_postActivity.this) ;
		...
		topicArraylist = new ArrayList<Topic>();
			...
			if(sameTopic!=null&"[]".equals(sameTopic)){
			for (int i = 0; i < sameTopic.length(); i++) {
				...
				topicArraylist.add(topic);
				  ...
				  pd.dismiss();
				  Toast.makeText(SameTopicList_postActivity.this, "沒有相關的話題", 1).show();
				  Intent i = new Intent(SameTopicList_postActivity.this,PostsDetialActivity.class);
