...
public class SearchNewFileActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
	   ...
	   // actor.setText(movie.getActor());
	    ...
	    btn_movie_new_about.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				  Intent sameTopicIntent = new Intent(SearchNewFileActivity.this,SearchSameTopicListActivity.class);
				  sameTopicIntent.putExtra("saydetial",homeLineDiscu);
				    startActivity(sameTopicIntent);
			}
		});
	    btn_movie_say.setOnClickListener(new OnClickListener() {
	    	
	    	@Override
	    	public void onClick(View v) {
	    		Intent i = new Intent(SearchNewFileActivity.this,PostOtherPostAcitvity.class);
	    ...
	    btn_movie_exit.setOnClickListener(new OnClickListener() {
	    	@Override
	    	public void onClick(View v) {
	    		Intent i = new Intent(SearchNewFileActivity.this,TableActivity.class);
	    		startActivity(i);
	    		finish();
	    	}
	    });
