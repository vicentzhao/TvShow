...
import cn.rushmedia.jay.tvshow.MyPostActivity.MyAdapter;
import cn.rushmedia.jay.tvshow.MyPostActivity.ViewHolder;
...
public class ProgramReviewListActivity_2 extends BaseActivity{
	int upid;
	...
	String fileDesc;
	MyHomeLineDiscu myHomeLineDiscu ;
		...
		tv_mytopic_nextpage=(Button) findViewById(R.id.tv_mytopic_nextpage);
		 ...
		 ImageButton backtohome = (ImageButton) findViewById(R.id.backtohome);
	    	...
	    	tv_reprogram_button.setOnClickListener(new OnClickListener() {
	    		public void onClick(View v) {
	    			 Intent sc =getIntent();
					 home = (MyHomeLineDiscu)sc.getSerializableExtra("saydetial");
	    			Intent i = new Intent(ProgramReviewListActivity_2.this,TopicDetialActivity.class);
...
//				@Override
//				public void onClick(View v) {
//	                  Intent i = new Intent(ProgramReviewListActivity_1.this,PostsDetialActivity.class);
//					  i.putExtra("saydetial",myHomeLineDiscu);
//	                  startActivity(i);
//				}
//			});
		 /**
...
listView.setSelection(lastItem - 1);//设置listview的当前位置，如果不设置每次加载完后都会返回到list的第一项。   
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
	                    ...
	                    if(totalItemCount!=0){
						   ...
						   // listView.addFooterView(loadingLayout);
							...
							tv_mytopic_nextpage.setOnClickListener(new OnClickListener() {
								...
								public void onClick(View v) {
									loadmoreItem();
									tv_mytopic_nextpage.setVisibility(View.INVISIBLE);
	            ...
	            if(firstVisibleItem < this.oldFirstVisibleItem){
						...
						tv_mytopic_previewpage.setOnClickListener(new OnClickListener() {
							...
							public void onClick(View v) {
								loadlessItem();
								tv_mytopic_previewpage.setVisibility(View.INVISIBLE);
								adapter.notifyDataSetChanged();
							}
						});
					}
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> parent, View view,
					...
					Intent intent = new Intent(ProgramReviewListActivity_2.this,PostsDetialActivity_1.class);
					Log.i("system", "触发点击事件");
					myHomeLineDiscu=myHomeLineDiscList.get(position);
...
//				 tv_mytopic_nextpage.setVisibility(View.GONE);
				if (result !=null) {
					 adapter = new MyAdapter(ProgramReviewListActivity_2.this,result);
						listView.setAdapter(adapter);
					
				}else{
					Toast.makeText(getApplicationContext(), "没有相关的帖子", 1)
					.show();
					finish();
				}
			...
			protected JSONArray doInBackground(Void... params) {
				try {
					 ...
					 Intent it =getIntent();
					 MyHomeLineDiscu homeLiMyHomeLineDiscuneDiscu =(MyHomeLineDiscu)it.getSerializableExtra("saydetial");
					 programid =homeLiMyHomeLineDiscuneDiscu.getTopic().getProgramid();
					//	String path ="http://tvsrv.webhop.net:8080/api/users/"+userid+"/homeline";
						...
						JsonUtil jsut = new JsonUtil();
						 String s =jsut.getStringSource(path);
						 array = new JSONArray(s);
							
						 if(array!=null&&!"[]".equals(s)){
						 ...
						 js =array.getJSONObject(i);
						  JSONObject jsUser=js.getJSONObject("user");
						   ...
						   filmName=jsProgram.getString("title");
						    fileDesc =jsProgram.getString("description");
						   }else{
							   filmName="极品电影";
						   }
						   Program program =new Program();
						   program.setImagePath(filmImagePath);
						   program.setDescription(fileDesc);
