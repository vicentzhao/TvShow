...
public class OthersTopicListActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent i = new Intent(OthersTopicListActivity.this,OthersTopicDetialActivity.class);
		...
		tv_topic_back_button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent i = new Intent(OthersTopicListActivity.this,UserDetailActivity.class);
